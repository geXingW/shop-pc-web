  ...
  <div class="w store-content">
    <div class="gray-box">
      ...
      <div class="banner">
        ...
        <div class="buy">
          <y-button text="加入购物车"
                    @btnClick="addCart(product.id,product.price,product.title,product.pic)"
                    classStyle="main-btn"
  ...
  export default {
    ...
    methods: {
      ...
      _productDet (productId) {
        ...
        // })
        let that = this
        info(productId).then( (data) => {
          if(data.status == 200000){
            that.product  = data.data
            that.productMsg = data.data.description || ''
            that.small.push(data.data.pic)
            that.big = data.data.pic
          }
        })
      },
